...
export async function up(knex) {
  ...
  VALUES
    ...
    ('directus_files','raster_tiling_configuration','alias,no-data,group','group-detail',NULL,NULL,NULL,FALSE,FALSE,NULL,'full',NULL,NULL,'[{"name":"Hide when file is not raster","rule":{"_and":[{"format_file":{"_nin":["tif","ecw"]}}]},"hidden":true,"options":{"start":"open"}}]',FALSE,'task_configurations',NULL,NULL),
    ('directus_files','raster_alias',NULL,'input',NULL,NULL,NULL,FALSE,FALSE,NULL,'full',NULL,NULL,'[{"name":"Require when file is raster","rule":{"_and":[{"format_file":{"_in":["tif","ecw"]}}]},"required":true,"options":{"font":"sans-serif","trim":false,"masked":false,"clear":false,"slug":false}}]',FALSE,'raster_tiling_configuration',NULL,NULL),
    ...
    ('directus_files','is_terrain','cast-boolean','boolean','{"label":"True"}',NULL,NULL,FALSE,FALSE,NULL,'full',NULL,NULL,'[{"name":"Require when file is raster","rule":{"_and":[{"format_file":{"_in":["tif","ecw"]}}]},"required":true,"options":{"iconOn":"check_box","iconOff":"check_box_outline_blank","label":"True"}}]',FALSE,'raster_tiling_configuration',NULL,NULL),
